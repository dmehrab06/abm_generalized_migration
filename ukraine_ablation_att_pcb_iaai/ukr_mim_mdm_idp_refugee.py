...
def refine_through_peer_effect(temp_household,current_phase=0):
    ...
    h_network_peer_move_count['peer_affected_move'] = h_network_peer_move_count.apply(lambda x: apply_threshold_function(x['moves_x'],x['moves_y'],THRESH_LO,THRESH_HI),axis=1)
